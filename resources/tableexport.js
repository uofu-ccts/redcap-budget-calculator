            ...
            exporters: {
                build: function (context, key) {
                    ...
                    var getReturn = function (val) {
                        ...
                        if (val.getElementsByTagName('input')[0] !== undefined) {
                            content = val.getElementsByTagName('input')[0].value;
                            console.log(content);
                        }
                        else if (val.getElementsByTagName('span')[0] !== undefined) {
                            content = val.getElementsByTagName('span')[0].innerText;
                        }
                        else {
                            content = val.innerText;
                        }

                        if (_isEnhanced(key)) {
                            return {
                                v: settings.formatValue(content),
                        ...
                        switch (key) {
                            case _FORMAT.CSV:
                                console.log(content);
                                return '"' + settings.formatValue(content.replace(/"/g, '""')) + '"';
                            default:
