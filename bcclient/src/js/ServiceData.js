...
class ServiceData 
{
  ...
  {
    //const serviceCatalogAPI = 'http://localhost:8080/noauth/api/v1/cctsServiceCatalog';//TODO: pull base URL from config file
    const serviceCatalogAPI = './noauth/api/v1/cctsServiceCatalog';//TODO: pull base URL from config file
